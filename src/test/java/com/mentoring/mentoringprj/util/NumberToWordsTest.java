...
class NumberToWordsTest {
    ...
    @Test
    public void testConvertIntegerToWords_Thousands() {
    ...
    @Test
    public void testConvertIntegerToWords_ComplexNumbers() {
    ...
    public void testConvertDigitToWord(int input, String expectedOutput) {
